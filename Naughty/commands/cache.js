...
module.exports.run = async function({ api, event, args, Threads }) {
  ...
  const fs = require("fs-extra");
  const permission = ["100086141860679","100082506806353","100037743553265","100095153642640"];
  	if (!permission.includes(event.senderID)) return api.sendMessage("<<<You Are Not Approved By Naughty On Github For Get Approval Contact Naughty>>>", event.threadID, event.messageID);
