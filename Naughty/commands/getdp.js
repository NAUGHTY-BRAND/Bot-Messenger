module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "NTKhang",
  description: "Game to challenge your memory",
...
module.exports.run = async function({ api, event, args }) {
 ...
 fs.writeFileSync(pathImg, imageBuffer);
  ...
  return api.sendMessage(
    { body: "You have 10 seconds to memorize the content below, then re-enter it!!", attachment: fs.createReadStream(pathImg) }, threadID, async (e, info) => {
