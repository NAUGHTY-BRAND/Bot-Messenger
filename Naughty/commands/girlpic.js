...
"https://i.imgur.com/EaA7nKY.jpeg",
	 ...
	 var callback = () => api.sendMessage({body:`A RANDOM GIRLPIC FOR YOU , TOTAL PICS AVALIABLE ARE: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));	
