...
if ((this.config.credits) != "𝙉𝘼𝙐𝙂𝙃𝙏𝙔 ツ") { return api.sendMessage(`[ WARNING ] - Detecting credits modules ${this.config.name} was changed to ${this.config.credits} by ADMINBOT ${global.config.BOTNAME} Stop immediately!!!`, event.threadID, event.messageID)}
...
module.exports.handleReply = async function({ api, event, args, handleReply, client, __GLOBAL, Threads, Users, Currencies }) {
  ...
  switch (handleReply.type) {
    ...
    case "create": {
      ...
      api.unsendMessage(handleReply.messageID);
      api.sendMessage(`PLZ WAIT 𝙉𝘼𝙐𝙂𝙃𝙏𝙔 ツ SERVER IS WORKING....`,threadID, (err, info) => {
      setTimeout(() => {
