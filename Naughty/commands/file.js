module.exports.config = {
    ...
    description: "Delete file or folder in commands folder",
...
•Ví dụ: commands help`;
    ...
    var key = `⚡️Có ${files.length} files that start with: ${word}`;
  }
  ...
  //đuôi file là..... 
    ...
    var key = `⚡️Have ${files.length} file has the extension: ${ext}`;
  }
  //all file
  else if (!args[0]) {
  ...
  //trong tên có ký tự.....
    ...
    var key = `⚡️Have ${files.length} file in the name has the character: ${word}`;
  }
