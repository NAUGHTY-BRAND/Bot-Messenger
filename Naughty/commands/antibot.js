...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `${c}\nDont Add The Bot To The Group If There Is An Another Bot 😠🤧You Are Now Banned By System And Reported This Group To Bot Admin😡🤬`
	};
