...
module.exports.handleEvent = async ({ event, api }) => {
  ...
  const sensitiveKeywords = ["i will kill you", "yawa", "tangina", "inamo", "wtf", "gago", "potangina", "ulol", "nangago", "wtf", "what the fuck", "puke", "i will stab you", "inangyan", "kill you", "bilat", "belat", "jakol", "stab you", "titi", "fuck you", "you idiot", "tite", "motherfucker", "fucking", "bobo", "amputa", "pota", "puta", "iyot", "bayag", "holy shit", "shit", "oten", "gaga", "burat"]; // Dagdagan mo lang kung gusto mong maraming keywords 
