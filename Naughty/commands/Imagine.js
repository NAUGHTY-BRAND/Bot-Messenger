...
module.exports.run = async function ({ api, event, args }) {
  try {
    ...
    // const API = `https://api.samirthakuri.repl.co/api/generatev3?prompt=${encodeURIComponent(prompt)}&ratio=3:2`;
    const API = `https://ea-sy.tech/api/luosiallen?q=${encodeURIComponent(prompt)}`;
