module.exports.config = {
  ...
  version: "1.0.0",
  hasPermssion: 0,
  credits: "Mirai Team (modified by Jonell Magallanes A.K.A pagod na daw mag code",
  prefix: true,
...
module.exports.onLoad = async function () {
  ...
  const path = resolve(__dirname, "cache", "customrank");
    ...
    if (!existsSync(resolve(__dirname, 'cache', 'regular-font.ttf'))) await downloadFile("https://raw.githubusercontent.com/SyntaxError1011/ok/main/James%20Fajardo.ttf", resolve(__dirname, 'cache', 'regular-font.ttf'));
  if (!existsSync(resolve(__dirname, 'cache', 'bold-font.ttf'))) await downloadFile("https://raw.githubusercontent.com/SyntaxError1011/ok/main/ArmWrestler.ttf", resolve(__dirname, 'cache', 'bold-font.ttf'));
  if (!existsSync(resolve(__dirname, 'cache', 'rankcard.png'))) await downloadFile("https://raw.githubusercontent.com/magallanes10/Rankup3/master/rankupjonell.png", resolve(__dirname, 'cache', 'rankcard.png'));
}
