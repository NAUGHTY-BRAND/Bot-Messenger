module.exports.config = {
    ...
    credits: "𝙉𝘼𝙐𝙂𝙃𝙏𝙔 ツ",
    hasPermssion: 0,
    description: "See Top User Money, User Level, Boxes Level, Box Money, ",
...
function TX(tx, i, x) {
  return `━━━━━━━━━━━━━━━\n${i >= 11 ? `➜ 𝗕𝗮̣𝗻 𝗵𝗶𝗲̣̂𝗻 𝗻𝗮̆́𝗺 𝗴𝗶𝘂̛̃ 𝘃𝗶̣ 𝘁𝗿𝗶́ 𝘁𝗵𝘂̛́: ${i}\n➜ ${tx == "money" ? `𝗠𝗢𝗡𝗘𝗬: ${CC(x)} vnđ` : `𝗟𝗘𝗩𝗘𝗟: ${LV(x)}`}` : i >= 1 && i <= 4 ? "➜ 𝗛𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 𝗯𝗮̣𝗻 𝗰𝗼́ 𝗺𝗮̣̆𝘁 𝘁𝗿𝗼𝗻𝗴 𝗱𝗮𝗻𝗵 𝘀𝗮́𝗰𝗵 𝗧𝗢𝗣 𝟭𝟬 " : i == 0 ? "➜ 𝗛𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 𝗯𝗮̣𝗻 𝗻𝗮̆́𝗺 𝗴𝗶𝘂̛̃ 𝘃𝗶̣ 𝘁𝗿𝗶́ 𝗧𝗢𝗣 𝟭 " : "➜ 𝗛𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 𝗯𝗮̣𝗻 𝗰𝗼́ 𝗺𝗮̣̆𝘁 𝘁𝗿𝗼𝗻𝗴 𝗱𝗮𝗻𝗵 𝘀𝗮́𝗰𝗵 𝗧𝗢𝗣 𝟭𝟬"}`
}